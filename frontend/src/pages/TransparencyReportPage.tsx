...
const TransparencyReportPage = () => {
  const handleDownload = () => {
    // Redirect to Google Drive link for Transparency Report
    window.open("https://drive.google.com/file/d/4d5e6f7g8h9i0j1k2l3m4n5o6p7q8r9s/view?usp=sharing", "_blank");
  };
