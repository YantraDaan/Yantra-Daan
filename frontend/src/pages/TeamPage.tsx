...
const TeamPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      {/* Popup for hovered member */}
      {hoveredMember && (
        <div 
          className="fixed z-50 bg-white rounded-xl shadow-2xl border border-gray-200 p-6 max-w-sm w-full"
          style={{ 
            ...
            <div className="flex-shrink-0">
              {hoveredMember.avatar ? (
                <div className="w-16 h-16 rounded-lg overflow-hidden border-2 border-white shadow-md">
                  <img 
                    src={getImageUrl(hoveredMember.avatar)} 
                    alt={hoveredMember.name}
                    className="w-full h-full object-cover"
                  />
                </div>
              ) : (
                <div className="w-16 h-16 bg-gradient-to-r from-primary to-accent rounded-lg flex items-center justify-center shadow-md">
